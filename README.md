...
34)[Given a string in which the letter h occurs at least twice. Remove from ](Day34.md)that string the first and the last occurrence of the letter h, as well as all the characters between them.](Day34.md)
